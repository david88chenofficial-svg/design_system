...
Open that directory as a separate Obsidian vault. It can build a new engineering reasoning workflow from a short design objective, evolve an existing workflow, and generate exact model/function/equation links inside the relevant stage, decision, reason and evidence records. AI changes remain review-first and project-scoped; source code is read-only.
